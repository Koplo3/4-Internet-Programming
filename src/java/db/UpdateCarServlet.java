...
public class UpdateCarServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        jdbcUtility.prepareSQLStatementUpdateCarByID();
    }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {                    
            PreparedStatement ps = jdbcUtility.getPsUpdateCarByID();
            ...
            if (updateStatus == 1) {
                out.println("<script>");
                out.println("    alert('Car update success');");
	...
	catch (SQLException ex)
	{
		...
		System.out.println ("");
            ...
            out.println("<script>");
            out.println("    alert('Car update failed');");
            out.println("    window.location = 'CarServlet'");
            out.println("</script>");            
	}
